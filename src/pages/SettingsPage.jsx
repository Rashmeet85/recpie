    ...
    <div style={{ padding: '56px 20px 24px' }}>
      ...
      <SettingsSection title="Export Collection" icon="📥" delay="0.12s">
        <SettingsButton
          ...
          sub={`${recipes.length} recipes -> styled PDF`}
        />
        <SettingsButton
          onClick={() => handleExport('docx')}
          loading={exporting === 'docx'}
          icon="📝"
          label="Export all as Word"
      ...
      <SettingsSection title="Import" icon="📤" delay="0.2s">
        <label
          style={{
            display: 'flex',
            alignItems: 'center',
      ...
      <SettingsSection title="About" icon="🎂" delay="0.24s">
        <div style={{ padding: '16px', background: 'rgba(255,255,255,0.6)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.85)' }}>
          ...
          <p style={{ margin: 0, fontFamily: 'var(--font-body)', fontSize: 13, color: 'var(--light-warm)', lineHeight: 1.6 }}>
            A premium personal recipe book to collect, format, and export your baking creations. Works offline and stores data locally.
          </p>
        </div>
      </SettingsSection>
